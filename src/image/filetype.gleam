...
pub fn get_image_type(filename: String) -> ImageType { get_image_type_private(filename, image_signatures) }
fn get_image_type_private(filename: String, signatures: List(#(ImageType, Offset, Signature))) -> ImageType {
  case signatures {
    [] -> Other
